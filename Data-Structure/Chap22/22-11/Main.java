  ...
  public class Main
{
    public static void main(String[] args)
  {
      ...
      for( int i=0; i<=province.length-1; i++)
          hashMap.put(province[i][0],province[i][1]);
      
      int correctCount = 0;
      for( int i=0; i<=9; i++)
         {
            Map.Entry<String,String> current = randomProvince(hashMap);
            String input = JOptionPane.showInputDialog(null,"What is the capital of "+current.getKey(),"Input",JOptionPane.QUESTION_MESSAGE);
            String answer = input.equals(current.getValue())? "correct": "wrong";
    ...
    public static Map.Entry<String,String> randomProvince(Map hashMap)
  {
